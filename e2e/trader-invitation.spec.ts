...
test.describe("Trader Invitation System", () => {
  test("complete invitation flow - send, accept, delete", async ({ page }) => {
    ...
    // 2. Navigate to trader dashboard invitations tab
    ...
    // Wait for page reload to complete (triggered by invitation success)
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(2000); // Extra buffer for table to render after reload
