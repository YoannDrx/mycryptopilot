  ...
  try {
    ...
    const subscribePromises = connections
      ...
      .map(async (conn) => {
        ...
        try {
          // Decrypt API keys (simplified - assumes encryption service)
          const apiKey = conn.encryptedApiKey; // TODO: Decrypt
          const secretKey = conn.encryptedSecretKey; // TODO: Decrypt
