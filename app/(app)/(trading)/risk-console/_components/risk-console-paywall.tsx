...
export function RiskConsolePaywall({ currentPlan }: RiskConsolePaywallProps) {
        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <div className="space-y-2">
            <CardTitle className="text-3xl font-bold">
              Upgrade to unlock the Risk Console
            </CardTitle>
            <p className="text-muted-foreground">
              You are currently on the {planLabel} plan. Upgrade to Pro or Ultra
              to access advanced risk management tools.
            </p>
          </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <Button asChild size="lg">
              <Link href="/pricing?upgrade=risk-console">
