...
import { TAX_LINKS } from "./tax-links";
 ...
 * - Simplified header
 *
 * Sidebar dédiée à l'espace Tax & Declaration
 * Affiche les 2 liens Tax
 */
export function TaxSidebar({ allLinks }: { allLinks: SerializableGroup[] }) {
