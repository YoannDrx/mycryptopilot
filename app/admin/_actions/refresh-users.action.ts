...
/**
 * Action serveur pour rafraîchir les données utilisateurs
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans UsersCard.
 */
export const refreshUsersAction = authAction
