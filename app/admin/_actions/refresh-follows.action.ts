...
/**
 * Action serveur pour rafraîchir les données de follows
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans FollowsCard.
 */
export const refreshFollowsAction = authAction
