...
/**
 * Action serveur pour rafraîchir les données d'exchanges
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans ExchangesCard.
 */
export const refreshExchangesAction = authAction
