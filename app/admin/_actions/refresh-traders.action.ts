...
/**
 * Action serveur pour rafraîchir les données traders
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans TradersCard.
 */
export const refreshTradersAction = authAction
