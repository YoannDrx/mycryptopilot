...
/**
 * Action serveur pour rafraîchir les données de paiements
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans PaymentsCard.
 */
export const refreshPaymentsAction = authAction
