...
/**
 * Action serveur pour rafraîchir les données de referrals
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans ReferralsCard.
 */
export const refreshReferralsAction = authAction
