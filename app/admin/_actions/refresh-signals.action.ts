...
/**
 * Action serveur pour rafraîchir les données signaux
 *
 * Cette action:
 ...
 *
 * Utilisée par le bouton de refresh manuel dans SignalsCard.
 */
export const refreshSignalsAction = authAction
