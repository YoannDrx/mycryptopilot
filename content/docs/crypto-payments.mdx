...
2. You'll be redirected to `/checkout/[plan]` (`app/(app)/(trading)/checkout/[plan]/page.tsx`).
...
- View historical payments in **Account → Payments** (`app/(app)/(account)/account/payments/page.tsx`).
